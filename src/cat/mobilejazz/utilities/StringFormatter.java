...
public class StringFormatter {
	...
	public static  <V> CharSequence printIterable(Iterable<V> iterable, CharSequence delimiter) {
		return printIterable(iterable, delimiter, (ObjectPrinter<V>)DefaultObjectPrinter.getInstance());
	}
	...
	public static  <V> CharSequence printIterable(CharSequence delimiter, V... array) {
		return printIterable(delimiter, (ObjectPrinter<V>)DefaultObjectPrinter.getInstance(), array);
	}
